const moveDB = {
  ...
  "Phatom Quill": {"type": "Ghost", "category": "Physical", "power": 90, "accuracy": 100, "pp": 10,priority: 0,crit:0,eff: 0},
  "Blazing Vault": {"type": "Fire", "category": "Physcal", "power": 85, "accuracy": 90, "pp": 10,priority: 1,crit:0,eff: 0},
  "Aqua Tremor": {"type": "Water", "category": "Physical", "power": 100, "accuracy": 95, "pp": 15, priority: -1,crit:0,eff: 0},
    ...
    "Flare Blitz": {"type": "Fire", "category": "Physical", "power": 120, "accuracy": 100, "pp": 15,priority: 0,crit:0,eff: 1},
    ...
    //3Grass
  "Absorb":        { type: "Grass", category: "Special", power: 20, accuracy: 100, pp: 25, priority: 0,crit:0,eff: 1 },
  "Mega Drain":    { type: "Grass", category: "Special", power: 40, accuracy: 100, pp: 15, priority: 0,crit:0 ,eff: 1},
  ...
  "Wood Hammer":   { type: "Grass", category: "Physical", power: 120, accuracy: 100, pp: 15, priority: 0,crit:0 ,eff: 1},
  ...
  "Wild Charge":   { type: "Electric", category: "Physical", power: 90, accuracy: 100, pp: 15, priority: 0,crit:0 ,eff: 1},
  "Volt Tackle":   { type: "Electric", category: "Physical", power: 120, accuracy: 100, pp: 15, priority: 0,crit:0 ,eff: 1},
  ...
  "Pursuit":       { type: "Dark", category: "Physical", power: 40, accuracy: 100, pp: 20, priority: 0 ,crit:0,eff: 0},
  ...
  "Brave Bird":     { type: "Flying", category: "Physical", power: 120, accuracy: 100, pp: 15, priority: 0,crit:0 ,eff: 1},
  ...
  "Take Down":       { type: "Normal", category: "Physical", power: 90, accuracy: 85, pp: 20, priority: 0 ,crit:0,eff: 1},
  "Double-Edge":    { type: "Normal", category: "Physical", power: 120, accuracy: 100, pp: 15, priority: 0 ,crit:0,eff: 1},
